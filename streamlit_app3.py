...
def generate_report_text(predicted_class, confidence, stage_prob,p_name='Krishang',
    ...
    Start by Mentioning the Title of the report, Then Patient Name in next line, Patient Age next line, Patient Gender next line,
    then give your analysis.

    Always include the probabilities of all the stages that you predicted after you share the predicted stage and its confidence level.
...
def add_watermark(canvas, doc):
    ...
    canvas.drawCentredString(A4[0] / 2, A4[1] / 2, "Generated by VNIT MedAssistant AI")
    canvas.restoreState()
